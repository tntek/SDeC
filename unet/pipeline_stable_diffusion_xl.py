...
class StableDiffusionXLPipeline(
    ...
    def encode_prompt(
        ...
        if prompt_embeds is None:
            ...
            #     prompt_embeds=prompt_embeds+pertubation
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # alpha = 0.5
        # id_embed=self.encode_prompt(id_prompt)[0]
    
        # prompt_embeds=alpha*id_embed+(1-alpha)*single_prompt_embeds
